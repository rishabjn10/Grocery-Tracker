...
from app.services.order_service import process_order_screenshot
...
async def upload_order_screenshot(
    ...
    try:
        ...
        order = process_order_screenshot(db, temp_file_path, current_user.get("user_id"))
...
def get_order(
    ...
    return None  # get_order_by_id(db, order_id)
